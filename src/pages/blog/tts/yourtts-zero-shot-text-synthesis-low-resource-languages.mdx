...
👉 [Try the YourTTS demo](https://coqui.ai)
...
YourTTS is an extension of our previous work [SC-GlowTTS](https://arxiv.org/pdf/2104.05557.pdf).
...
built on the [GlowTTS](https://arxiv.org/pdf/2005.11129.pdf) model. The GlowTTS
...
performance. We also use [speaker encoder cosine similarity (SECS)](https://arxiv.org/pdf/2104.05557.pdf) to
...
Give YourTTS a try right on your browser using the demo on our [homepage](https://coqui.ai).
