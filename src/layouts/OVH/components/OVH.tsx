...
const rawRowData = [
  { index: 1, language: 'Abkhaz', task: 'Constrained Vocabulary', competitionID: '117' },
  { index: 2, language: 'Abkhaz', task: 'Large Vocabulary', competitionID: '141' },
  { index: 3, language: 'Arabic', task: 'Constrained Vocabulary', competitionID: '118' },
  { index: 4, language: 'Arabic', task: 'Large Vocabulary', competitionID: '150' },
  ...
  { index: 9, language: 'Basque', task: 'Constrained Vocabulary', competitionID: '124' },
  { index: 10, language: 'Basque', task: 'Large Vocabulary', competitionID: '159' },
  ...
  { index: 14, language: 'Catalan', task: 'Constrained Vocabulary', competitionID: '123' },
  { index: 15, language: 'Catalan', task: 'Constrained Vocabulary', competitionID: '207' },
  { index: 16, language: 'Catalan', task: 'Large Vocabulary', competitionID: '168' },
  { index: 17, language: 'Chinese (Hong Kong)', task: 'Large Vocabulary', competitionID: '204' },
  { index: 18, language: 'Chuvash', task: 'Constrained Vocabulary', competitionID: '120' },
  { index: 19, language: 'Chuvash', task: 'Large Vocabulary', competitionID: '147' },
  { index: 20, language: 'Czech', task: 'Constrained Vocabulary', competitionID: '122' },
  { index: 21, language: 'Czech', task: 'Large Vocabulary', competitionID: '149' },
  { index: 22, language: 'Dhivehi', task: 'Large Vocabulary', competitionID: '152' },
  { index: 23, language: 'Dutch', task: 'Constrained Vocabulary', competitionID: '130' },
  { index: 24, language: 'Dutch', task: 'Large Vocabulary', competitionID: '194' },
  { index: 25, language: 'English', task: 'Constrained Vocabulary', competitionID: '137' },
  { index: 26, language: 'English', task: 'Large Vocabulary', competitionID: '163' },
  { index: 27, language: 'Esperanto', task: 'Constrained Vocabulary', competitionID: '211' },
  { index: 28, language: 'Estonian', task: 'Large Vocabulary', competitionID: '153' },
  { index: 29, language: 'Finnish', task: 'Large Vocabulary', competitionID: '155' },
  { index: 30, language: 'French', task: 'Constrained Vocabulary', competitionID: '206' },
  { index: 31, language: 'Frisian', task: 'Constrained Vocabulary', competitionID: '125' },
  { index: 32, language: 'Frisian', task: 'Large Vocabulary', competitionID: '158' },
  { index: 33, language: 'Galician', task: 'Large Vocabulary', competitionID: '162' },
  { index: 34, language: 'Georgian', task: 'Constrained Vocabulary', competitionID: '127' },
  { index: 35, language: 'Georgian', task: 'Large Vocabulary', competitionID: '167' },
  { index: 36, language: 'German', task: 'Constrained Vocabulary', competitionID: '208' },
  { index: 37, language: 'Greek', task: 'Large Vocabulary', competitionID: '151' },
  { index: 38, language: 'Guarani', task: 'Large Vocabulary', competitionID: '157' },
  { index: 39, language: 'Hakha', task: 'Large Vocabulary', competitionID: '145' },
  { index: 40, language: 'Hindi', task: 'Large Vocabulary', competitionID: '164' },
  { index: 41, language: 'Hungarian', task: 'Large Vocabulary', competitionID: '172' },
  { index: 42, language: 'Indonesian', task: 'Constrained Vocabulary', competitionID: '126' },
  { index: 43, language: 'Indonesian', task: 'Large Vocabulary', competitionID: '170' },
  { index: 44, language: 'Interlingua', task: 'Large Vocabulary', competitionID: '165' },
  { index: 45, language: 'Irish', task: 'Large Vocabulary', competitionID: '156' },
  { index: 46, language: 'Japanese', task: 'Large Vocabulary', competitionID: '202' },
  ...
  { index: 51, language: 'Kyrgyz', task: 'Constrained Vocabulary', competitionID: '128' },
  { index: 52, language: 'Kyrgyz', task: 'Large Vocabulary', competitionID: '171' },
  ...
  { index: 55, language: 'Luganda', task: 'Constrained Vocabulary', competitionID: '129' },
  { index: 56, language: 'Luganda', task: 'Large Vocabulary', competitionID: '180' },
  ...
  { index: 60, language: 'Odia', task: 'Large Vocabulary', competitionID: '173' },
  { index: 61, language: 'Polish', task: 'Constrained Vocabulary', competitionID: '132' },
  { index: 62, language: 'Polish', task: 'Large Vocabulary', competitionID: '191' },
  { index: 63, language: 'Portuguese', task: 'Constrained Vocabulary', competitionID: '133' },
  { index: 64, language: 'Portuguese', task: 'Large Vocabulary', competitionID: '192' },
  ...
  { index: 69, language: 'Russian', task: 'Constrained Vocabulary', competitionID: '135' },
  { index: 70, language: 'Russian', task: 'Large Vocabulary', competitionID: '196' },
  ...
  { index: 75, language: 'Spanish', task: 'Constrained Vocabulary', competitionID: '210' },
  { index: 76, language: 'Swedish', task: 'Constrained Vocabulary', competitionID: '136' },
  { index: 77, language: 'Swedish', task: 'Large Vocabulary', competitionID: '183' },
  { index: 78, language: 'Taiwanese Mandarin', task: 'Large Vocabulary', competitionID: '203' },
  { index: 79, language: 'Tamil', task: 'Constrained Vocabulary', competitionID: '138' },
  { index: 80, language: 'Tamil', task: 'Large Vocabulary', competitionID: '199' },
  { index: 81, language: 'Tatar', task: 'Constrained Vocabulary', competitionID: '140' },
  { index: 82, language: 'Tatar', task: 'Large Vocabulary', competitionID: '195' },
  { index: 83, language: 'Thai', task: 'Large Vocabulary', competitionID: '197' },
  { index: 84, language: 'Turkish', task: 'Constrained Vocabulary', competitionID: '139' },
  { index: 85, language: 'Turkish', task: 'Large Vocabulary', competitionID: '193' },
  { index: 86, language: 'Ukrainian', task: 'Large Vocabulary', competitionID: '200' },
  { index: 87, language: 'Upper', task: 'Large Vocabulary', competitionID: '161' },
  { index: 88, language: 'Urdu', task: 'Large Vocabulary', competitionID: '187' },
  { index: 89, language: 'Uyghur', task: 'Large Vocabulary', competitionID: '198' },
  { index: 90, language: 'Welsh', task: 'Constrained Vocabulary', competitionID: '121' },
