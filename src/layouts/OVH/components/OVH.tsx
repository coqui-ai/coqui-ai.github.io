...
const rawRowData = [
  ...
  { index: 76, language: 'Swedish', task: 'Large Vocabulary', competitionID: '183' },
  { index: 77, language: 'Swedish', task: 'Constrained Vocabulary', competitionID: '136' },
  { index: 78, language: 'Taiwanese Mandarin', task: 'Large Vocabulary', competitionID: '203' },
  { index: 79, language: 'Tamil', task: 'Large Vocabulary', competitionID: '199' },
  { index: 80, language: 'Tamil', task: 'Constrained Vocabulary', competitionID: '138' },
  { index: 81, language: 'Tatar', task: 'Large Vocabulary', competitionID: '195' },
  { index: 82, language: 'Tatar', task: 'Constrained Vocabulary', competitionID: '140' },
  { index: 83, language: 'Thai', task: 'Large Vocabulary', competitionID: '197' },
  { index: 84, language: 'Turkish', task: 'Large Vocabulary', competitionID: '193' },
  { index: 85, language: 'Turkish', task: 'Constrained Vocabulary', competitionID: '139' },
  ...
  { index: 90, language: 'Welsh', task: 'Large Vocabulary', competitionID: '148' },
  { index: 91, language: 'Welsh', task: 'Constrained Vocabulary', competitionID: '121' }
];
