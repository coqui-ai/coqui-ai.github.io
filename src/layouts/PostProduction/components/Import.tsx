...
export const Import: React.FC = () => {
  const patternsImage = useStaticQuery(
    graphql`
      query {
        file(relativePath: { eq: "images/post-production/import.jpg" }) {
          childImageSharp {
            fluid(maxWidth: 880) {
      ...
      <Grid gutters="lg">
        <Row alignItems="center" justifyContent="center">
          ...
          >
            <SectionCallout
              header="Import"
              description="Import the production or auxiliary audio assets, e.g. recordings of your voice talent, into Coqui's pipeline with the click of a button."
              css={css`
